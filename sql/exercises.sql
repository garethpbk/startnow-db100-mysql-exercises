...
SELECT payment_id, amount, payment_date FROM payment WHERE payment_date<20050528 AND payment_date>20050526595959;
...
SELECT staff_id, first_name, last_name, address_id, picture, email, store_id, active, username, last_update FROM staff WHERE password;
...
SELECT payment_id, amount, payment_date FROM payment WHERE DATE(payment_date) IN ("20050525", "20050527", "20050529");
...
SELECT * FROM payment WHERE payment_date BETWEEN 20050525000000 AND 20050526;
